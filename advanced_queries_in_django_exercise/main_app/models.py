...
class VideoGame(models.Model):
    ...
    release_year = models.PositiveIntegerField(
        validators=[RangeValidator(min_value=1990, max_value=2023, message="The release year must be between 1990 and 2023")])
    rating = models.DecimalField(max_digits=2,decimal_places=1,
        validators=[RangeValidator(min_value=Decimal('0'), max_value=Decimal('10'), message="The rating must be between 0.0 and 10.0")])
