# Generated by Django 5.0.4 on 2025-03-24 18:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(max_length=15, unique=True, validators=[main_app.validators.DigitsOnlyValidator(message='Phone must contain only digits!')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('astronauts', models.ManyToManyField(related_name='passengers', to='main_app.astronaut')),
                ('commander', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='main_app.astronaut')),
