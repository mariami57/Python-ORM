...
def filter_authors_by_birth_year(first_year, second_year)->str:
...
def change_reviewer_name(name, new_name) -> QuerySet:
    reviewers = Review.objects.filter(reviewer_name=name).update(reviewer_name=new_name)
